module DataLookupHelper
  ...
  def self.team_lookup
    @team_lookup ||= {
      "Washington Nationals" =>     ["WAS", "MON"],
      "Toronto Blue Jays" =>        "TOR",
      "Texas Rangers" =>            ["TEX", "WS2"],
      "Tampa Bay Rays" =>           "TBA",
      "St. Louis Cardinals" =>      ["SLN", "SL4"],
      "San Francisco Giants" =>     ["SFN", "NY1"],
      "Seattle Mariners" =>         "SEA",
      "San Diego Padres" =>         "SDN",
      "Pittsburgh Pirates" =>       ["PIT", "PT1"],
      "Philadelphia Phillies" =>    "PHI",
      "Athletics" =>                ["OAK", "PHA", "KC1"],
      "New York Yankees" =>         ["NYA", "BLA"],
      "New York Mets" =>            "NYN",
      "Minnesota Twins" =>          ["MIN", "WS1"],
      "Milwaukee Brewers" =>        ["MIL", "ML4", "SE1"],
      "Los Angeles Dodgers" =>      ["LAN", "BR3", "BRO"],
      "Kansas City Royals" =>       "KCA",
      "Houston Astros" =>           "HOU",
      "Miami Marlins" =>            ["MIA", "FLO"],
      "Detroit Tigers" =>           "DET",
      "Colorado Rockies" =>         "COL",
      "Cleveland Guardians" =>      "CLE",
      "Cincinnati Reds" =>          ["CIN", "CN2"],
      "Chicago White Sox" =>        "CHA",
      "Chicago Cubs" =>             "CHN",
      "Boston Red Sox" =>           "BOS",
      "Baltimore Orioles" =>        ["BAL", "MLA", "SLA"],
      "Atlanta Braves" =>           ["ATL", "BSN", "ML1"],
      "Arizona Diamondbacks" =>     "ARI",
      "Los Angeles Angels" =>       ["LAA", "ANA", "CAL"],
    }.freeze
  end
